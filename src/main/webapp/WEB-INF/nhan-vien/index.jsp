...
<div class="container">
    <div class="row py-5">
        ...
        <a href="/nhan-vien/create" class="btn btn-primary"><i
                class="bi bi-person-add"></i>
            Thêm</a>
        <nav class="navbar bg-body-tertiary">
            <div class="container-fluid">
                <form class="d-flex" role="search" action="/nhan-vien/search" method="post">
...
<table class="table table-striped table-hover">
    ...
    <c:forEach var="nhanVien" items="${nhanViens}">
        <tr>
            ...
            <td><a href="/nhan-vien/edit/${nhanVien.id}"
                   class="btn btn-outline-warning"><i class="bi bi-pencil"></i> Edit</a></td>
            <td><a href="/nhan-vien/delete/${nhanVien.id}"
    ...
    <nav aria-label="...">
        <ul class="pagination pagination-lg">
            <c:forEach var="i" begin="1" end="${endPage}">
                <li class="page-item">
                    <a class="page-link" href="/nhan-vien?paing=${i}">${i}</a></li>
            </c:forEach>
        </ul>
    </nav>
</div>
