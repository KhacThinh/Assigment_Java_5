...
<div class="container">
    <div class="row py-2">
        <form:form action="/mau-sac" method="POST" modelAttribute="dongSp">
            <div class="mb-3">
    ...
    <div class="row py-2">
        <form class="d-flex" role="search" action="/mau-sac/search" method="post">
    ...
    <table class="table table-striped table-hover">
        ...
        <c:forEach var="dongsp" items="${dongSanPhams}" varStatus="i">
            <tr>
                ...
                <td>${dongsp.ma}</td>
                <td>${dongsp.ten}</td>
                <td><a href="/mau-sac/view-update/${dongsp.id}"
