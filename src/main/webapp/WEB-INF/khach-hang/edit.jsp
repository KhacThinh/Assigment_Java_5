...
<div class="container">
    ...
    <div class="row py-2">
        <form:form modelAttribute="khachHang" method="post" action="/khach-hang/update">
            <div class="mb-3">
            ...
            <div class="row mb-3">
                <div class="col-md-8">
                    ...
                    <form:input path="matKhau" class="form-control" minlength="6"/>
                    <form:errors path="matKhau" class="text-danger"/>
                </div>
            </div>
            <a href="/khach-hang" class="btn btn-secondary"><i
                    class="bi bi-backspace"></i> Hủy</a>
            <form:button type="submit" class="btn btn-primary">Sửa Khách Hàng</form:button>
        </form:form>
    </div>
</div>
</body>
