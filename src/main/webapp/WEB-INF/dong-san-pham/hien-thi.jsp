...
<div class="container">
    <div class="row py-2">
        <form:form action="/dong-san-pham" method="POST" modelAttribute="dongSp">
            <div class="mb-3">
    ...
    <div class="row py-2">
        <form class="d-flex" role="search" action="/dong-san-pham/search" method="post">
    ...
    <table class="table table-striped table-hover">
        ...
        <c:forEach var="dongsp" items="${dongSanPhams}" varStatus="i">
            <tr>
                ...
                <td>${dongsp.ma}</td>
                <td>${dongsp.ten}</td>
                <td><a href="/dong-san-pham/view-update/${dongsp.id}"
